...
</script>	<noscript><meta http-equiv="refresh" content="0; URL=/files/josephephillipsjr/F31S4SNM8/ad_score.py?nojsmode=1" /></noscript>
<script>(function() {
        'use strict';
...
<script>(function() {
	...
	<script type="text/javascript">
		...
		sb('set', 'token', '3307f436963e02d4f9eb85ce5159744c');
					...
					sb('set', 'user_id', "U2PHB6562");
							sb('set', 'user_' + "batch", "signup_api");
							sb('set', 'user_' + "created", "2016-10-14");
						sb('set', 'name_tag', "kaggle6242" + '/' + "shoili");
				sb('track', 'pageview');
...
<script>TSSSB.env = (function() {
	...
	<script type="text/javascript">
	    ...
	    <title>ad_score.py | 6242 Slack</title>
    <meta name="author" content="Slack">
			...
			<!-- output_css "core" -->
    <link href="https://a.slack-edge.com/c26e/style/rollup-plastic.css" rel="stylesheet" type="text/css" crossorigin="anonymous">
    ...
    <link href="https://a.slack-edge.com/7b37b/style/codemirror_overrides.css" rel="stylesheet" type="text/css" crossorigin="anonymous">

	<!-- output_css "file_pages" -->
    <link href="https://a.slack-edge.com/98cc/style/rollup-file_pages.css" rel="stylesheet" type="text/css" crossorigin="anonymous">

	<!-- output_css "regular" -->
    <link href="https://a.slack-edge.com/53d7/style/print.css" rel="stylesheet" type="text/css" crossorigin="anonymous">
	...
	<div id="site_nav_contents">
		...
		<div id="user_menu">
			<div id="user_menu_contents">
				<div id="user_menu_avatar">
										<span class="member_image thumb_48" style="background-image: url('https://secure.gravatar.com/avatar/1c575f50c9b7c5f3dd916f067912f512.jpg?s=192&d=https%3A%2F%2Fa.slack-edge.com%2F7fa9%2Fimg%2Favatars%2Fava_0010-192.png')" data-thumb-size="48" data-member-id="U2PHB6562"></span>
					<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/1c575f50c9b7c5f3dd916f067912f512.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0010-72.png')" data-thumb-size="36" data-member-id="U2PHB6562"></span>
				</div>
				<h3>Signed in as</h3>
				<span id="user_menu_name">shoili</span>
			</div>
		</div>
		...
		<div class="nav_contents">
			...
			<ul class="primary_nav">
				...
				<ul id="admin_nav" class="secondary_nav">
					...
					<li><a href="/admin/billing" data-qa="billing" data-clog-event="WEBSITE_CLICK" data-clog-params="action=click,click_target=billing_nav,trigger=inc_nav,pay_prod_cur=,has_plan=true">Billing</a></li>
		...
		<div id="footer">
			...
			<ul id="footer_nav">
				...
				<li><a href="https://slack.com/signout/91599499143?crumb=s-1478997051-14301b6bb6-%E2%98%83" data-qa="sign_out">Sign Out<i class="ts_icon ts_icon_sign_out small_left_margin ts_icon_inherit"></i></a></li>
			</ul>
					...
					<span class="block label">Help</span>
						...
						<span class="block label">Launch</span>
				                    ...
				                    <ul id="header_team_nav" data-qa="team_switcher_menu">
	                        	                            <li class="active">
	                            	<a href="https://kaggle6242.slack.com/home" target="https://kaggle6242.slack.com/">
	                            			                            			<i class="ts_icon small ts_icon_check_circle_o active_icon s"></i>
	                            			                            			                            			<i class="team_icon small default" >6</i>
	                            			                            		<span class="switcher_label team_name">6242</span>
	                            	</a>
	                            </li>
...
<p class="print_only">
	<strong>Created by josephephillipsjr on November 12, 2016 at 4:29 PM</strong><br />
	<span class="subtle_silver break_word">https://kaggle6242.slack.com/files/josephephillipsjr/F31S4SNM8/ad_score.py</span>
</p>
...
<div class="alert_container">
	...
	<i class="ts_icon ts_icon_link"></i> Public Link: <a class="file_public_link" href="https://slack-files.com/T2PHMEP47-F31S4SNM8-a12f3cd3db" target="new">https://slack-files.com/T2PHMEP47-F31S4SNM8-a12f3cd3db</a>
</div></div>

<div id="file_page" class="card top_padding">

	<p class="small subtle_silver no_print meta">
		5KB Python snippet created on <span class="date">November 12th 2016</span>.
	...
	<div class="large_bottom_margin clearfix">
		<pre id="file_contents">import csv
import datetime
...
print(datetime.datetime.now().time())
	...
	<div class="col span_4_of_6 no_right_padding">
		...
		<form action="https://kaggle6242.slack.com/files/josephephillipsjr/F31S4SNM8/ad_score.py"
		id="file_comment_form"
					class="comment_form"
				method="post">
			<a href="/team/shoili" class="member_preview_link" data-member-id="U2PHB6562" >
			<span class="member_image thumb_36" style="background-image: url('https://secure.gravatar.com/avatar/1c575f50c9b7c5f3dd916f067912f512.jpg?s=72&d=https%3A%2F%2Fa.slack-edge.com%2F66f9%2Fimg%2Favatars%2Fava_0010-72.png')" data-thumb-size="36" data-member-id="U2PHB6562"></span>
		</a>
		<input type="hidden" name="addcomment" value="1" />
	<input type="hidden" name="crumb" value="s-1478997051-13da7ef377-☃" />
...
<!--
	...
	var boot_data = {
		...
		user_id: 'U2PHB6562',
		no_login: false,
		version_ts: '1478984033',
		version_uid: '3599e747703a06428e5919bc1d4ebf19ecb2f306',
		...
		feature_sli_search_limit_extracts: false,
		...
		feature_enterprise_conditional_team_removal: false,
		...
		feature_policy_effective_date: false,
		...
		feature_file_comment_help_text: false,
		feature_refactored_message_template: false,
		feature_message_inputs: false,
		feature_contact_us_form: true,
		feature_app_cards_and_profs_set_card_color: false,
		feature_cdn_load_tracking: false,
		feature_fresh_team_directory: false,
		feature_move_star_in_channel_header: false,
		feature_team_to_org_directory: true,
		feature_reposition_search_dropdown: false,
...
//-->
				...
				<!-- output_js "core" -->
<script type="text/javascript" src="https://a.slack-edge.com/61a52/js/rollup-core_required_libs.js" crossorigin="anonymous"></script>
<script type="text/javascript" src="https://a.slack-edge.com/ec3a/js/rollup-core_required_ts.js" crossorigin="anonymous"></script>
<script type="text/javascript" src="https://a.slack-edge.com/32b0/js/TS.web.js" crossorigin="anonymous"></script>

		<!-- output_js "core_web" -->
<script type="text/javascript" src="https://a.slack-edge.com/9982f/js/rollup-core_web.js" crossorigin="anonymous"></script>

		<!-- output_js "secondary" -->
<script type="text/javascript" src="https://a.slack-edge.com/dbd87/js/rollup-secondary_a_required.js" crossorigin="anonymous"></script>
<script type="text/javascript" src="https://a.slack-edge.com/b52340/js/rollup-secondary_b_required.js" crossorigin="anonymous"></script>

					
	<!-- output_js "regular" -->
<script type="text/javascript" src="https://a.slack-edge.com/4016/js/TS.web.comments.js" crossorigin="anonymous"></script>
<script type="text/javascript" src="https://a.slack-edge.com/c439/js/TS.web.file.js" crossorigin="anonymous"></script>
...
<script type="text/javascript" src="https://a.slack-edge.com/db4a/js/codemirror_load.js" crossorigin="anonymous"></script>
	...
	<!--
		...
		boot_data.file = {"id":"F31S4SNM8","created":1478996965,"timestamp":1478996965,"name":"ad_score.py","title":"ad_score.py","mimetype":"text\/plain","filetype":"python","pretty_type":"Python","user":"U2PHU05EV","editable":true,"size":5343,"mode":"snippet","is_external":false,"external_type":"","is_public":false,"public_url_shared":false,"display_as_bot":false,"username":"","url_private":"https:\/\/files.slack.com\/files-pri\/T2PHMEP47-F31S4SNM8\/ad_score.py","url_private_download":"https:\/\/files.slack.com\/files-pri\/T2PHMEP47-F31S4SNM8\/download\/ad_score.py","permalink":"https:\/\/kaggle6242.slack.com\/files\/josephephillipsjr\/F31S4SNM8\/ad_score.py","permalink_public":"https:\/\/slack-files.com\/T2PHMEP47-F31S4SNM8-a12f3cd3db","edit_link":"https:\/\/kaggle6242.slack.com\/files\/josephephillipsjr\/F31S4SNM8\/ad_score.py\/edit","preview":"import csv\r\nimport datetime\r\n\r\n#filename variables\r\n#clicks_train contains 87,141,732\r","preview_highlight":"\u003Cdiv class=\"CodeMirror cm-s-default CodeMirrorServer\" oncopy=\"if(event.clipboardData){event.clipboardData.setData('text\/plain',window.getSelection().toString().replace(\/\\u200b\/g,''));event.preventDefault();event.stopPropagation();}\"\u003E\n\u003Cdiv class=\"CodeMirror-code\"\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Ecsv\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-keyword\"\u003Eimport\u003C\/span\u003E \u003Cspan class=\"cm-variable\"\u003Edatetime\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E&#8203;\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E#filename variables\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003Cdiv\u003E\u003Cpre\u003E\u003Cspan class=\"cm-comment\"\u003E#clicks_train contains 87,141,732\u003C\/span\u003E\u003C\/pre\u003E\u003C\/div\u003E\n\u003C\/div\u003E\n\u003C\/div\u003E\n","lines":156,"lines_more":151,"preview_is_truncated":true,"channels":[],"groups":[],"ims":["D2PHZC8LA"],"comments_count":0};
	...
	//-->
		...
		<script type="text/javascript">
				TS.clog.setTeam('T2PHMEP47');
						TS.clog.setUser('U2PHB6562');
			</script>
...
<!-- slack-www-hhvm185 / 2016-11-12 16:30:51 / v3599e747703a06428e5919bc1d4ebf19ecb2f306 / B:H -->
